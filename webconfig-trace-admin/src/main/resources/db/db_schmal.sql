...
CREATE TABLE IF NOT EXISTS `trace_walking_compete` (
  ...
  `trace_start_time` datetime DEFAULT NULL COMMENT '链路开始的时间',
  `trace_end_time` datetime DEFAULT NULL COMMENT '链路的结束时间',
...
CREATE TABLE IF NOT EXISTS `trace_walking_method` (
  ...
  `span_start_time` datetime DEFAULT NULL COMMENT '子链路开始的时间',
  `span_end_time` datetime DEFAULT NULL COMMENT '子链路的结束时间',
